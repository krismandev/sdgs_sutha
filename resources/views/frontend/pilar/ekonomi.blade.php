                        ...
                        <div class="col-lg-4 col-12">
                            <div class="row">
                                <a href="{{asset('dokumen/pilar-ekonomi.pdf')}}">
                                    <img src="{{asset('frontend/images/ekonomi.jpg')}}" alt="" class="pilar-img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="row">
                                ...
                                <h5 style="color: white;">
                                    5 Goals, 54 Target, 71 Indikator
                                </h5>
                            </div>
                            <div class="row">
                                <span style="color: white;">Pembangunan Ekonomi SDGs adalah tercapainya pertumbuhan ekonomi berkualitas melali keberlanjutan peluang kerja dan usaha, inivasi, industri inklusif, infrastruktur memadai, energi bersih yang terjangkau dan didukung kemitraan</span>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row row-logo" style="margin-top: 20px;">
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',7)}}">
                                <img src="{{asset('images/logo-sdgs-07.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12 logo">
                            <a href="{{route('showTujuan',8)}}">
                                <img src="{{asset('images/logo-sdgs-08.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12 logo">
                            <a href="{{route('showTujuan',9)}}">
                                <img src="{{asset('images/logo-sdgs-09.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12 logo">
                            <a href="{{route('showTujuan',10)}}">
                                <img src="{{asset('images/logo-sdgs-10-1.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12 logo">
                            <a href="{{route('showTujuan',17)}}">
                                <img src="{{asset('images/logo-sdgs-17.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
        </div> <!-- /.container -->
