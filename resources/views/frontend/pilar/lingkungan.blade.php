                        ...
                        <div class="col-lg-4 col-12">
                            <div class="row">
                                <a href="{{asset('dokumen/pilar-lingkungan.pdf')}}">
                                    <img src="{{asset('frontend/images/lingkungan.jpg')}}" alt="" class="pilar-img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="row">
                                ...
                                <h5 style="color: white;">
                                    6 Goals, 56 Target, 70 Indikator
                                </h5>
                            </div>
                            <div class="row">
                                <span style="color: white;">Pembangunan Pembangunan Lingkungan SDGs adalah tercapainya pengelolaan sumberdaya alam dan lingkungan yang berkelanjutan sebagai penyangga seluruh kehidupan</span>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row row-logo" style="margin-top: 20px;">
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',6)}}">
                                <img src="{{asset('images/logo-sdgs-06.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',11)}}">
                                <img src="{{asset('images/logo-sdgs-11.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',12)}}">
                                <img src="{{asset('images/logo-sdgs-12.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',13)}}">
                                <img src="{{asset('images/logo-sdgs-13.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',14)}}">
                                <img src="{{asset('images/logo-sdgs-14.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',15)}}">
                                <img src="{{asset('images/logo-sdgs-15.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
        </div> <!-- /.container -->
