                        ...
                        <div class="col-lg-4 col-12">
                            <div class="row">
                                <a href="{{asset('dokumen/pilar-hukum.pdf')}}">
                                    <img src="{{asset('frontend/images/hukum.jpg')}}" alt="" class="pilar-img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="row">
                                ...
                                <h5 style="color: white;">
                                    1 Goals, 12 Target, 23 Indikator
                                </h5>
                            </div>
                            <div class="row">
                                <span style="color: white;">Pembangunan Hukum dan Tata Kelola SDGs adalah terwujudnya kepastian hukum dan tata kelola yang efektif, transparan, akuntabel dan partisipatif untuk menciptakan stabilitas keamanan dan mencapai negara berdasarkan hukum</span>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row row-logo" style="margin-top: 20px;">
                        <div class="col-lg-2 col-12  logo">
                            <a href="{{route('showTujuan',16)}}">
                                <img src="{{asset('images/logo-sdgs-16.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
        </div> <!-- /.container -->
